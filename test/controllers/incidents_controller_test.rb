...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { duration: @incident.duration, name: @incident.name, occurance: @incident.occurance }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { duration: @incident.duration, name: @incident.name, occurance: @incident.occurance }
    assert_redirected_to incident_path(assigns(:incident))
  end
